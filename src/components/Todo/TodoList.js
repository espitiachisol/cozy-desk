...
const TodoList = ({
  lists, checkComplete, deleteList, priority,
}) => (
  <>
    {lists.map((listdata) => (
      <div className="todo-list" key={listdata.id}>
        ...
        >
          {listdata.complete ? <img src="/images/icon_check.svg" alt="icon-check" /> : null}
        </button>
...
&nbsp;
          ...
          <div className="todo-list-priority">
            <div className={`todo-list-priority-circle ${listdata.priority}`} />
